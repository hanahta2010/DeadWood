...
public abstract class Deadwood {
  ...
  public Player maxPlayer;	  
	//public Deadview ded;
	public abstract HashMap<String, Room> getRooms();  
  ...
  public boolean dayEnd() {
	  ...
	  for (int i = 0; i < playerList.size(); i++) {
		  ...
		  if (finalScore(playerList.get(i)) > maxPlayerS) {
			  ...
			  this.maxPlayer = playerList.get(i);
		  }
	  }
	  System.out.println("The player " + this.maxPlayer.getName() + " is a winner. Congratulation! Too bad, no prize... :P");
	  System.out.println();
	  return true;
  }
...
// Calculate the player's score  
  public int finalScore(Player player) {
	  ...
	  this.totalScore = money + credit + rank * 5;

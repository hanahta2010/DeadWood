...
public class Player {
	...
	public void setRoleAndRehearse(int roleAndRehearse) {
		this.roleAndRehearse = roleAndRehearse;
	}
	
	public int getRoleAndRehearse() {
		return roleAndRehearse;
	}
...
// Calculate the amount they get to pay when they act
	public boolean doAct() {
		...
		roleAndRehearse = dice.roll() + role.rehearseCredit;
		if (roleAndRehearse >= stage.getCard().getBudget()) {
